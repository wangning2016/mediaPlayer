...
#define FFMPEG_CONFIGURATION "--enable-debug --extra-cflags=-g --enable-libx264 --enable-gpl --enable-static --enable-shared --disable-optimizations --disable-stripping --enable-x86asm --enable-yasm --enable-pthreads"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 8 (Uos 8.3.0.9-1+eagle)"
